...
const HeroLeft = ({ companyInfo }: Props) => (
  <div className='heroLeft'>
    ...
    <div className='title__sub'>{companyInfo?.description}</div>

    {companyInfo?.hireUsLink && (
      <a href={companyInfo?.hireUsLink} target='_blank' rel='noreferrer'>
        <button type='button' className='primary__button mt-5'>
          Hire Us
        </button>
      </a>
    )}
